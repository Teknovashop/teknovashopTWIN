...
export async function POST(req: NextRequest){
  try{
    ...
    const prefs = { name: body.name || '', email: body.email || '', category: body.category || 'fitness', budget: Number(body.budget) || 100, style: body.style || 'minimalista', goal: body.goal || 'mejor calidad/precio', audience: body.audience || 'unisex' }
