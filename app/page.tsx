...
<section className="rounded-2xl bg-gradient-to-br from-gray-900 to-gray-700 text-white p-6"><h2 className="text-3xl font-bold">Tu clon de compras por IA</h2><p className="mt-2 text-gray-200">Dinos tu estilo y presupuesto. Te armamos un mini-carrito perfecto.</p></section>
