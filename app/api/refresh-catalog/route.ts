...
export async function GET(){
  try{
    ...
    const { url } = await put('catalog/catalog-latest.json', new Blob([payload],{type:'application/json'}), { access:'public', addRandomSuffix:false, contentType:'application/json', cacheControlMaxAge:0 })
