...
const useStore=create<Store>((set)=>({prefs:{category:'fitness',budget:100,style:'minimalista',goal:'mejor calidad/precio',n:6,audience:'unisex'},setPrefs:(p)=>set((s)=>({prefs:{...s.prefs,...p}}))}))
